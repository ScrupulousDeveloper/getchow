async function fetchData() {
  try {
    const response = await fetch(
      "https://scrupulousdeveloper.github.io/getchow/dome.models/users.db.json"
    );
    if (!response.ok) {
